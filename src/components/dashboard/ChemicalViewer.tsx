  ...
  return (
    <div className="rounded-2xl border bg-card p-6" style={{ borderColor: '#D0DCF0' }}>
      ...
      <div className="flex items-start justify-between mb-5">
        <div>
          <h2 className="font-serif text-lg font-semibold italic" style={{ color: '#003369' }}>Visualisasi Struktur Kimia</h2>
          <p className="text-xs mt-0.5" style={{ color: '#003369', opacity: 0.5 }}>Data live dari PubChem · klik bahan untuk memuat</p>
        </div>
        {info && (
          <a
