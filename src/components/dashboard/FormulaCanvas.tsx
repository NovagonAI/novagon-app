...
function QTPPPanel({ h1, h2, constraints }: QTPPPanelProps) {
  ...
  return (
    <div className="flex flex-col gap-4 h-full overflow-y-auto">
      ...
      {/* Stability card */}
      <div className="rounded-2xl border bg-card p-4" style={{ borderColor: '#D0DCF0' }}>
        <p className="text-xs font-semibold mb-3" style={{ color: '#003369' }}>QTPP — Stabilitas Emulsi</p>
      ...
      {/* Shelf life card */}
      <div className="rounded-2xl border bg-card p-4" style={{ borderColor: '#D0DCF0' }}>
        <p className="text-xs font-semibold mb-2" style={{ color: '#003369' }}>QTPP — Estimasi Shelf Life</p>
        <div className="flex items-baseline gap-1.5">
          <span className="font-serif text-3xl font-semibold italic" style={{ color: '#003369' }}>{h1.shelfLifeDays}</span>
      ...
      {/* Viscosity card */}
      <div className="rounded-2xl border bg-card p-4" style={{ borderColor: '#D0DCF0' }}>
        <p className="text-xs font-semibold mb-3" style={{ color: '#003369' }}>QTPP — Viskositas</p>
        <ViscosityBar value={h2.value} lo={h2.lo} hi={h2.hi} />
      </div>

      {/* Safety / irritation + pH */}
      <div className="rounded-2xl border bg-card p-4" style={{ borderColor: '#D0DCF0' }}>
        <p className="text-xs font-semibold mb-3" style={{ color: '#003369' }}>QTPP — Keamanan & pH</p>
...
export function FormulaCanvas() {
  return (
    <div className="rounded-2xl border bg-card overflow-hidden" style={{ borderColor: '#D0DCF0' }}>
      {/* Header */}
      <div className="flex items-center justify-between px-6 py-4 border-b" style={{ borderColor: '#D0DCF0' }}>
        <div>
          <h2 className="font-serif text-lg font-semibold italic" style={{ color: '#003369' }}>Analisis Formulasi — FM-2381</h2>
          <p className="text-xs mt-0.5" style={{ color: '#003369', opacity: 0.5 }}>Visualisasi interaksi molekuler · prediksi QTPP · cek regulasi</p>
        </div>
      </div>

      {/* Legend */}
      <div className="px-6 py-2 border-b" style={{ borderColor: '#D0DCF0', backgroundColor: '#EBF4FF' }}>
        <ComplianceLegend />
      </div>
      ...
      <div className="flex flex-col lg:flex-row">
        ...
        {/* Divider */}
        <div className="hidden lg:block w-px self-stretch" style={{ backgroundColor: '#D0DCF0' }} aria-hidden="true" />
        <div className="block lg:hidden h-px mx-6" style={{ backgroundColor: '#D0DCF0' }} aria-hidden="true" />
