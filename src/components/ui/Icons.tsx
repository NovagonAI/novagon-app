/**
 * Shared SVG icon components — Heroicons outline style (24px viewBox).
 * Ukuran default 16×16. Override lewat className atau width/height prop.
 */
...
export function IconSquares2x2(p: IconProps) {
  return (
    <svg {...base} {...p}>
      <path strokeLinecap="round" strokeLinejoin="round"
...
export function IconInformationCircle(p: IconProps) {
  return (
    <svg {...base} {...p}>
      <path strokeLinecap="round" strokeLinejoin="round"
...
export function IconCog6Tooth(p: IconProps) {
  return (
    <svg {...base} {...p}>
      <path strokeLinecap="round" strokeLinejoin="round"
...
export function IconCodeBracket(p: IconProps) {
  return (
    <svg {...base} {...p}>
...
export function IconArrowPath(p: IconProps) {
  return (
    <svg {...base} {...p}>
      <path strokeLinecap="round" strokeLinejoin="round"
